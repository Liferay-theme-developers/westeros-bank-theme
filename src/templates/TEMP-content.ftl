			...
			<div class="active item">
				<div class="item-wrapper">
					...
					<div class="col-sm-5 col-sm-offset-6 col-xs-12">
						...
						<p><a class="btn btn-default btn-theme-default" href="#">Organic caffeine</a></p>
					</div>
				</div>
			</div>
			<div class="item">
				<div class="item-wrapper">
					...
					<div class="col-sm-5 col-sm-offset-6 col-xs-12">
						...
						<p><a class="btn btn-default btn-theme-default" href="#">Rich macchiato cinnamon</a></p>
					</div>
				</div>
			</div>
			<div class="item">
				<div class="item-wrapper">
					...
					<div class="col-sm-5 col-sm-offset-6 col-xs-12">
						...
						<p class="lead">Seasonal mazagran organic caffeine french press affogato acerbic espresso. Sugar mocha brewed flavour fair trade grounds spoon.</p>
						<p><a class="btn btn-default btn-theme-default" href="#">Qui aroma</a></p>
					</div>
				</div>
			</div>
		</div>
...
<div class="text-column">
	<section class="container-fluid-1280">
		...
		<div class="col-md-6 col-md-offset-3 col-xs-10 col-xs-offset-1">
			<p>Saucer, pumpkin spice, dark beans wings acerbic caffeine cinnamon doppio. Arabica, con panna mocha organic single shot wings saucer grinder.</p>
			<p>Filter breve, <strong>bar cream</strong> plunger pot shop trifecta. Filter, cup, et affogato, saucer sugar, blue mountain sweet as robust decaffeinated organic.</p>
			<div class="alert alert-info theme-alert">
				<p>ES98 1465 0100 95 6000000000</p>
			</div>
			<p>Cup steamed acerbic dripper, milk frappuccino doppio con panna caffeine rich cortado.</p>
		</div>
	</section>
</div>
...
<!-- SMALL TEXT COLUMN -->
	...
	<div class="text-column">
		<section class="container-fluid-1280">
			<div class="col-md-8 col-md-offset-2">
				<h2 class="text-center">Kopi-luwak siphon french <u class="theme-underlined">irish</u> espresso arabica</h2>
			</div>
			<div class="col-md-6 col-md-offset-3 col-xs-10 col-xs-offset-1">
				<p>Robust, crema coffee cup qui cappuccino cortado café au lait id so half and half. Percolator blue mountain, plunger pot brewed irish beans decaffeinated et froth. Sit, steamed pumpkin spice rich bar instant espresso arabica black.</p>
			</div>
		</section>
	</div>
		...
		<section class="container-fluid-1280">
			<div class="col-sm-4">
				...
				<div class="content-wrapper">
					...
					<p><a class="small text-uppercase" href="#"><strong>Turkish est froth</strong></a></p>
				</div>
			</div>
			<div class="col-sm-4">
				...
				<div class="content-wrapper">
					...
					<p><a class="small text-uppercase" href="#"><strong>Whipped decaffeinated</strong></a></p>
				</div>
			</div>
			<div class="col-sm-4">
				...
				<div class="content-wrapper">
					...
					<p><a class="small text-uppercase" href="#"><strong>Affogato chicory</strong></a></p>
				</div>
			</div>
		</section>
	</div>
